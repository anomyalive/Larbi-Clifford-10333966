...
--  Student : Larbi Clifford 
--  Index No: 10333966
--  Course  : SQL Practical  – Week 8 Assignment 2
--  Date    : 15 May 2026
...
VALUES
    (1100, 'Clifford Larbi',     '12 Liberation Road',    'Accra',     'Greater Accra', 'GA-100-001', 'clifford.larbi@email.com'),
    (1101, 'Rejoice Mallen',        '45 Kejetia Market St',  'Kumasi',    'Ashanti',       'AS-100-002', 'rejoice.mallen@email.com'),
    (1102, 'Jadida Bella',     '8 Oxford Street',       'Accra',     'Greater Accra', 'GA-100-003', 'jedida.bella@email.com'),
    (1103, 'Asare Abena',        '23 Harbour Road',       'Takoradi',  'Western',       'WR-100-004', 'asare.abena@email.com'),
    (1104, 'Kweku Obeng',        '15 Central Market Rd',  'Kumasi',    'Ashanti',       'AS-100-005', 'kweku.obeng@email.com'),
    (1105, 'Brent Hale',   '33 Tamale Road',        'Tamale',    'Northern',      'NR-100-006', 'brent.hale@email.com');
